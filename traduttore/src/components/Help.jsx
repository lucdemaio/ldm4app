    ...
    <div className="card">
      ...
      <section style={{ marginTop: 12 }}>
        ...
        <ol style={{ marginTop: 8 }}>
          <li><strong>Primo Avvio</strong>: il download non parte automaticamente. Usa il link "Scarica modello (.bin)" in alto per scaricare il file principale del modello (~600MB), poi premi il pulsante <strong>Carica modello</strong> per avviare il motore. Vedrai quindi la barra di caricamento; al termine il motore rimarrà residente nel browser.</li>
